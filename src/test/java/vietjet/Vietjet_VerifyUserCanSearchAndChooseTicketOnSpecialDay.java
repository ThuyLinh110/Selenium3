...
public class Vietjet_VerifyUserCanSearchAndChooseTicketOnSpecialDay extends TestBase {
    ...
    public void vietjet_VerifyUserCanSearchAndChooseTicketOnSpecialDay() {
        ...
        Assertion.assertEquals(selectFlightPage.getHighlightedDate(), Common.formatDateToLocalizedDayMonth(departureDate), "VP: Verify the return flights dates are displayed correctly");
